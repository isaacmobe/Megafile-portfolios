...
function linkAction() {
  const navMenu = document.getElementById("nav-menu");
  // when we click a nav link, we remove the show menu class
  navMenu.classList.remove("show-menu");
}
...
function scrollHeader() {
  ...
  //when the scroll is greater than 80vh, add the class scroll header
...
//get al sections that have an id defined
